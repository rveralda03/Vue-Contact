    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                ...
                <p class="fst-italic">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Provident magnam atque eligendi, aspernatur minima reprehenderit placeat quidem, delectus fugiat necessitatibus sit sapiente, labore perspiciatis? Aliquam unde ducimus enim dolores natus.</p>
                <form>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
...
export default {
    ...
    methods : {
        clickDeleteContact : async function (contactId){
            try {
                let response = await ContactService.deleteteContact(contactId);
                if(response){
                    let response = await ContactService.getAllContacts();
                    this.contacts = response.data;
                    this.loading = false;
